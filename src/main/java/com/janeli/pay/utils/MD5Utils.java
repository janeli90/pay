/**@Title: MD5Utils.java 
 * @Package com.webside.swiftpass.util 
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author tianlei   
 * @date 2016年9月28日 上午11:45:18 
 * @version V1.0   
 */
...
/**@ClassName: MD5Utils 
 * @Description: TODO(MD5签名) 
 * @author tianlei
 * @date 2016年9月28日 上午11:45:18 
 */
public class MD5Utils {
	public static void main(String[] args) {
//        String str = "src=p6iHp2Hy6HPyA5ZVS5yPxw==&tel=13548661930";
//        System.out.println(MD5Utils.sign(str, "NS3yeZWUodCS2tG5i8N4CbBN2nnlEbJ5", "utf-8"));
//
//        System.out.println(genEncryptKey(32));

        System.out.println(DigestUtils.md5Hex("654321" + "8328388437"));
    }
    ...
    public static boolean checkParam(Map<String,String> params, String key){
        ...
        if(params.containsKey("sign")){
            ...
            String signRecieve = MD5Utils.sign(preStr, key, "utf-8");
     ...
     * @return
     */
    public static String encrypt(String inbuf,String charset) {
        return md5.md5Encrypt(inbuf,charset);
    }
     ...
     */
    public String md5Encrypt(String inbuf) {
        return md5Encrypt(inbuf,"utf-8");

    }

    public String md5Encrypt(String inbuf,String charset) {
        md5Init();
        try {
            byte[] datas = inbuf.getBytes(charset);
            md5Update(datas, datas.length);
        } catch (UnsupportedEncodingException e) {
        }
        md5Final();
        String digestHexStr = "";
